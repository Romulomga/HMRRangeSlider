 ...
 */
- (void)rangeSlider:(HMRRangeSlider *)sender didEndTouchesInLeftHandle:(BOOL)leftSelected orRightHandle:(BOOL)rightSelected;

/**
 * Called when the user has started interacting with the RangeSlider
 */
- (void)rangeSlider:(HMRRangeSlider *)sender didStartTouchesInLeftHandle:(BOOL)leftSelected orRightHandle:(BOOL)rightSelected;
