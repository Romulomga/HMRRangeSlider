 ...
 */
@interface HMRRangeSliderLeftElement : UIAccessibilityElement
@end

/**
 An accessibility element that increments and decrements the right slider
 */
@interface HMRRangeSliderRightElement : UIAccessibilityElement
@end

static const CGFloat kLabelsFontSize = 12.0f;

@implementation HMRRangeSlider
...
- (BOOL)continueTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    if ([self.delegate respondsToSelector:@selector(rangeSlider:willChangeLeftHandle:orRightHandle:)]){
...
{
    HMRRangeSliderLeftElement *element = [[HMRRangeSliderLeftElement alloc] initWithAccessibilityContainer:self];
...
{
    HMRRangeSliderRightElement *element = [[HMRRangeSliderRightElement alloc] initWithAccessibilityContainer:self];
    element.isAccessibilityElement = YES;
...
@implementation HMRRangeSliderLeftElement
...
@implementation HMRRangeSliderRightElement
